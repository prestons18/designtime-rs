 ...
 * This function processes nodes one by one. For better performance, we'll use a batch renderer.
 */
export function renderFromJson(json: string): void;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly renderFromJson: (a: number, b: number) => [number, number];
  readonly main: () => void;
